...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/root/headscale-management/.cursor/.gsd-surface.json`
(sibling to `/root/headscale-management/.cursor/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/root/headscale-management/.cursor/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/root/headscale-management/.cursor/skills`).
...
`/root/headscale-management/.cursor/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/root/headscale-management/.cursor/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/root/headscale-management/.cursor/.gsd-surface.json`
Install profile marker: `/root/headscale-management/.cursor/.gsd-profile`
Skill dirs: `/root/headscale-management/.cursor/skills/gsd-*/`
Engine module: `/root/headscale-management/.cursor/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/root/headscale-management/.cursor/gsd-core/bin/lib/clusters.cjs`
</execution_context>
