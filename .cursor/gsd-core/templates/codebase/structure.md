...
- Usage: Reference from command with `@/root/headscale-management/.cursor/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /root/headscale-management/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /root/headscale-management/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
