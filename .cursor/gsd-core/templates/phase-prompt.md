...
<!-- For checkpoint task examples and patterns, see @/root/headscale-management/.cursor/gsd-core/references/checkpoints.md -->
...
See `/root/headscale-management/.cursor/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/root/headscale-management/.cursor/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/root/headscale-management/.cursor/gsd-core/workflows/verify-phase.md` for verification logic.
