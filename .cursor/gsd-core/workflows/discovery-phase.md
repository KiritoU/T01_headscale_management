...
See /root/headscale-management/.cursor/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /root/headscale-management/.cursor/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using /root/headscale-management/.cursor/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /root/headscale-management/.cursor/gsd-core/templates/discovery.md
...
Use /root/headscale-management/.cursor/gsd-core/templates/discovery.md.
