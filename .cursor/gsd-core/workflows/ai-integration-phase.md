...
<required_reading>
@/root/headscale-management/.cursor/gsd-core/references/ai-frameworks.md
@/root/headscale-management/.cursor/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /root/headscale-management/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/root/headscale-management/.cursor/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /root/headscale-management/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /root/headscale-management/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /root/headscale-management/.cursor/agents/gsd-eval-planner.md for instructions.
