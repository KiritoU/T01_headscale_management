...
INSTALL_JS_GLOBAL="/root/headscale-management/.cursor/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /root/headscale-management/.cursor/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
