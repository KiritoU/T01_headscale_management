...
```bash
INIT=$(node "/root/headscale-management/.cursor/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/root/headscale-management/.cursor/gsd-core/templates/spec.md.
