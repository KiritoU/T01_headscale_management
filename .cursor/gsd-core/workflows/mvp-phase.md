...
<required_reading>
@/root/headscale-management/.cursor/gsd-core/references/user-story-template.md
@/root/headscale-management/.cursor/gsd-core/references/spidr-splitting.md
@/root/headscale-management/.cursor/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/root/headscale-management/.cursor/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `conversational prompting` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/root/headscale-management/.cursor/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/root/headscale-management/.cursor/gsd-core/references/spidr-splitting.md`. Briefly:
