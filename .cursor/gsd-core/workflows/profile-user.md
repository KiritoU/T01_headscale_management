...
Key references:
- @/root/headscale-management/.cursor/gsd-core/references/ui-brand.md (display patterns)
- @/root/headscale-management/.cursor/agents/gsd-user-profiler.md (profiler agent definition)
- @/root/headscale-management/.cursor/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/root/headscale-management/.cursor/gsd-core/USER-PROFILE.md"
...
```bash
cp "/root/headscale-management/.cursor/gsd-core/USER-PROFILE.md" "/root/headscale-management/.cursor/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /root/headscale-management/.cursor/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/root/headscale-management/.cursor/gsd-core/references/user-profiling.md`
...
Reference: @/root/headscale-management/.cursor/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /root/headscale-management/.cursor/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .cursor/rules/" -- "Add profile to /root/headscale-management/.cursor/.cursor/rules/ for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /root/headscale-management/.cursor/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /root/headscale-management/.cursor/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /root/headscale-management/.cursor/.cursor/rules/"
...
```bash
BACKUP_PATH="/root/headscale-management/.cursor/USER-PROFILE.backup.md"
```
...
Your profile:    /root/headscale-management/.cursor/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /root/headscale-management/.cursor/skills/gsd-dev-preferences/SKILL.md
  ✓ .cursor/rules/ section       .cursor/rules/
  ✓ Global .cursor/rules/        /root/headscale-management/.cursor/.cursor/rules/
```
