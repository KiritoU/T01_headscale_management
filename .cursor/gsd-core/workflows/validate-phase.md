...
```
Agent(
  prompt="Read /root/headscale-management/.cursor/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/root/headscale-management/.cursor/gsd-core/templates/VALIDATION.md`
