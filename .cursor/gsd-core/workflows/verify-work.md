...
<template>
@/root/headscale-management/.cursor/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/root/headscale-management/.cursor/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/root/headscale-management/.cursor/gsd-core/workflows/transition.md`.
...
- Follow @/root/headscale-management/.cursor/gsd-core/workflows/diagnose-issues.md
