...
```markdown
Read /root/headscale-management/.cursor/agents/gsd-ui-researcher.md for instructions.
...
Template: /root/headscale-management/.cursor/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /root/headscale-management/.cursor/agents/gsd-ui-checker.md for instructions.
