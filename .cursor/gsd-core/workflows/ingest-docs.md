...
```bash
INIT=$(node "/root/headscale-management/.cursor/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/root/headscale-management/.cursor/gsd-core/bin/gsd-tools.cjs" commit \
